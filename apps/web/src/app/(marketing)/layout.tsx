        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-900">Encore</span>
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-colors">Download</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="mailto:support@encore.app" className="text-gray-400 hover:text-purple-400 transition-colors">Contact</a></li>

    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Add Concert</h1>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                {selectedArtists.length === 0 && (
                  <p className="text-sm text-red-600">At least one artist is required</p>
                )}
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:border-primary-500 focus:ring-2 focus:ring-primary-500 focus:ring-offset-1 transition-colors duration-200"
              />
            </CardContent>
          </Card>
